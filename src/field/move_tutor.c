...
TutorMove sTutorMoves[] = {
    ...
    { MOVE_FIRE_FANG, 0, MOVE_TUTOR_NPC_FRONTIER_TOP_LEFT },
    { MOVE_ICE_FANG, 0, MOVE_TUTOR_NPC_FRONTIER_TOP_LEFT },
    ...
    { MOVE_THUNDER_FANG, 0, MOVE_TUTOR_NPC_FRONTIER_TOP_LEFT },
    ...
    { MOVE_LOW_SWEEP, 0, MOVE_TUTOR_NPC_FRONTIER_TOP_LEFT },
