...
TutorMove sTutorMoves[] = {
    { MOVE_BRICK_BREAK,    0, MOVE_TUTOR_NPC_FRONTIER_TOP_LEFT     },
    { MOVE_FIRE_PUNCH,     0, MOVE_TUTOR_NPC_FRONTIER_TOP_LEFT     },
    { MOVE_ICE_PUNCH,      0, MOVE_TUTOR_NPC_FRONTIER_TOP_LEFT     },
    { MOVE_POISON_JAB,     0, MOVE_TUTOR_NPC_FRONTIER_TOP_LEFT     },
    { MOVE_THUNDER_PUNCH,  0, MOVE_TUTOR_NPC_FRONTIER_TOP_LEFT     },
    { MOVE_SHADOW_PUNCH,   0, MOVE_TUTOR_NPC_FRONTIER_TOP_LEFT     },
    { MOVE_HYDRO_PUMP,     0, MOVE_TUTOR_NPC_FRONTIER_TOP_RIGHT    },
    { MOVE_THUNDER,        0, MOVE_TUTOR_NPC_FRONTIER_TOP_RIGHT    },
    { MOVE_FIRE_BLAST,     0, MOVE_TUTOR_NPC_FRONTIER_TOP_RIGHT    },
    { MOVE_POWER_WHIP,     0, MOVE_TUTOR_NPC_FRONTIER_TOP_RIGHT    },
    { MOVE_STONE_EDGE,     0, MOVE_TUTOR_NPC_FRONTIER_TOP_RIGHT    },
    { MOVE_HURRICANE,      0, MOVE_TUTOR_NPC_FRONTIER_TOP_RIGHT    },
    { MOVE_BLIZZARD,       0, MOVE_TUTOR_NPC_FRONTIER_TOP_RIGHT    },
    { MOVE_FOCUS_BLAST,    0, MOVE_TUTOR_NPC_FRONTIER_TOP_RIGHT    },
    { MOVE_ZAP_CANNON,     0, MOVE_TUTOR_NPC_FRONTIER_TOP_RIGHT    },
    { MOVE_INFERNO,        0, MOVE_TUTOR_NPC_FRONTIER_TOP_RIGHT    },
    { MOVE_HELPING_HAND,  40, MOVE_TUTOR_NPC_FRONTIER_TOP_LEFT     },
    { MOVE_ENDEAVOR,      64, MOVE_TUTOR_NPC_FRONTIER_TOP_LEFT     },
    { MOVE_OUTRAGE,       48, MOVE_TUTOR_NPC_FRONTIER_TOP_LEFT     },
    { MOVE_ANCIENT_POWER, 40, MOVE_TUTOR_NPC_FRONTIER_TOP_LEFT     },
    ...
    { MOVE_BUG_BITE,       0, MOVE_TUTOR_NPC_FRONTIER_BOTTOM_RIGHT },
