...
u16 sIndigoPlateau[] = {
    ITEM_WHITE_HERB, ITEM_POWER_HERB, ITEM_BOOSTER_ENERGY, 0xFFFF
};
...
u16 sMahoganyPostRocketHideout[] = {
    ITEM_MEGANIUMITE, ITEM_CHESNAUGHTITE, ITEM_CRABOMINITE, ITEM_HAWLUCHANITE, ITEM_SCOVILLAINITE, ITEM_DRAMPANITE, 0xFFFF
};
