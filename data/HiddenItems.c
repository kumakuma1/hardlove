...
const HiddenItemData sHiddenItemParam[] = {
    ...
    { ITEM_BIG_NUGGET, 1, 0, 0, 1 }, // Cherrygrove
    { ITEM_BIG_NUGGET, 1, 0, 0, 225 }, // Cherrygrove
    { ITEM_POTION, 1, 0, 0, 2 }, // R30
    { ITEM_HEART_SCALE, 1, 0, 0, 14 }, // Dark Cave
    { ITEM_MAX_ETHER, 1, 0, 0, 15 }, // Dark Cave
    { ITEM_MAX_REVIVE, 1, 0, 0, 16 }, // Dark Cave
    { ITEM_HEART_SCALE, 1, 0, 0, 17 }, // Dark Cave
    { ITEM_ELIXIR, 1, 0, 0, 18 }, // Dark Cave
    { ITEM_HEART_SCALE, 1, 0, 0, 3 }, // Violet
    ...
    { ITEM_HEART_SCALE, 1, 0, 0, 153 }, // Union Cave B1F S
    { ITEM_REVIVE, 1, 0, 0, 155 }, // Union Cave B1F E
    { ITEM_GRASS_GEM, 1, 0, 0, 156 }, // Union Cave B2F SW
    { ITEM_ROCK_GEM, 1, 0, 0, 157 }, // Union Cave B2F W
    ...
    { ITEM_PSYCHIC_GEM, 1, 0, 0, 29 }, // Slowpoke Well B1F Ladder
    ...
    { ITEM_TINY_MUSHROOM, 1, 0, 0, 212 }, // Ilex Forest
    { ITEM_HEART_SCALE, 1, 0, 0, 213 }, // Ilex Forest W Surf
    { ITEM_TINY_MUSHROOM, 1, 0, 0, 214 }, // Ilex Forest
    { ITEM_TINY_MUSHROOM, 1, 0, 0, 215 }, // Ilex Forest
    { ITEM_HEART_SCALE, 1, 0, 0, 7 }, // R34 Centre
    ...
    { ITEM_HEART_SCALE, 1, 0, 0, 10 }, // R35 NW
    ...
    { ITEM_HEART_SCALE, 1, 0, 0, 133 }, // Ecruteak W
    { ITEM_HEART_SCALE, 1, 0, 0, 19 }, // Burned Tower Entrance N
    { ITEM_ULTRA_BALL, 1, 0, 0, 20 }, // Burned Tower Entrance SW
    { ITEM_FIGHTING_GEM, 1, 0, 0, 65 }, // Burned Tower Basement NW
    { ITEM_DARK_GEM, 1, 0, 0, 21 }, // Burned Tower Basement S
    ...
    { ITEM_ICE_GEM, 1, 0, 0, 73 }, // Whirl Islands
    { ITEM_DRAGON_GEM, 1, 0, 0, 74 }, // Whirl Islands
    { ITEM_FAIRY_GEM, 1, 0, 0, 191 }, // Whirl Islands
    { ITEM_HEART_SCALE, 1, 0, 0, 192 }, // Whirl Islands
    { ITEM_HEART_SCALE, 1, 0, 0, 193 }, // Whirl Islands
    { ITEM_HEART_SCALE, 1, 0, 0, 75 }, // Whirl Islands
    ...
    { ITEM_FIRE_GEM, 1, 0, 0, 57 }, // Underground Path
    { ITEM_WATER_GEM, 1, 0, 0, 58 }, // Underground Path
    ...
    { ITEM_RAGE_CANDY_BAR, 1, 0, 0, 106 }, // Cerulean
    { ITEM_HEART_SCALE, 1, 0, 0, 107 }, // R25
    ...
    { ITEM_HEART_SCALE, 1, 0, 0, 112 }, // R12 //moved to SS Aqua
    ...
    { ITEM_HEART_SCALE, 1, 0, 0, 230 }, // R46
};
